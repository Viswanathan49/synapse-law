...
import BatchComparatorModal from './BatchComparatorModal.jsx';
...
function SavedMemoryModal({ isOpen, onClose, user, onLoadMemoryToWorkspace }) {
  ...
  return (
    <>
      <div className="memory-modal-backdrop animate-fadeIn" role="dialog" aria-modal="true" aria-label="Saved Memory Vault">
        <div className="memory-modal-card glass-card animate-fadeInUp">
          ...
          <div className="memory-modal-header">
            ...
            <button className="auth-close-btn" onClick={onClose} aria-label="Close Vault Modal">✕</button>
          </div>

          {/* Filter Bar */}
          <div className="memory-filter-bar" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
            ...
            {memories.length > 0 && (
              <button
                ...
                aria-label="Open Batch Portfolio Risk Audit Modal"
              >
                📊 Batch Audit Portfolio
              </button>
            )}
          </div>
                  ...
                  <div className="memory-item-header">
                    ...
                    <div style={{ display: 'flex', alignItems: 'center', gap: '8px' }}>
                      ...
                      <button
                        ...
                        title="Delete Memory"
                        aria-label={`Delete ${mem.filename} memory`}
                      >
                        🗑️
                      </button>
                    </div>
      ...
      {/* Batch Portfolio Risk Audit Modal */}
      <BatchComparatorModal
        isOpen={isBatchOpen}
