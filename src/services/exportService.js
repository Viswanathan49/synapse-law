 ...
 * @param {string} [filename='synapse-law-brief.pdf']
 */
export async function exportToPDF(element, filename = 'synapse-law-brief.pdf') {
  try {
    ...
    console.error('[Synapse Law] PDF export error:', error);
 ...
 * @param {string} [filename='synapse-law-brief.pptx']
 */
export async function exportToPPT(brief, riskData = null, filename = 'synapse-law-brief.pptx') {
  try {
    ...
    function makeSlide(titleText, slideNum, totalSlides) {
      ...
      // Bottom footer
      slide.addText(`Synapse Law  |  Slide ${slideNum} of ${totalSlides}  |  Legal Consultation Preparation`, {
    ...
    // ── Slide 1: Cover Slide ──────────────────────────────────
    {
      ...
      slide.addText('SYNAPSE LAW  |  LEGAL CONSULTATION BRIEF', {
    ...
    // ── Slide: Legal Disclaimer ───────────────────────────────
    {
      ...
      slide.addText(
        'This briefing was generated by Synapse Law for INFORMATIONAL PURPOSES ONLY.\n\n' +
        '1. Synapse Law is not a law firm and does NOT provide formal legal advice, legal representation, or legal opinions.\n\n' +
      ...
      slide.addText('© 2026 Synapse Law — Legal Intelligence Platform', {
    ...
    console.error('[Synapse Law] PPT export error:', error);
